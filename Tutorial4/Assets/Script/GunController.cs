...
public class GunController : MonoBehaviour
{
    ...
    private void Hit()
    {
        ...
        {
            GameObject clone = Instantiate(hit_effect_prefab, hitInfo.point,
    ...
    {
        while (currentGun.transform.localPosition !=
    ...
    {
        Vector3 recoilBack = new Vector3(currentGun.retroActionForce,
        ...
        if (!isFineSightMode)
        {
            ...
            // 반동 시작
            while (currentGun.transform.localPosition.x <=
                currentGun.retroActionForce - 0.02f)
            {
                currentGun.transform.localPosition =
                    Vector3.Lerp(currentGun.transform.localPosition,
                    recoilBack, 0.4f);
        ...
        else
        {
            ...
            // 반동 시작
            while (currentGun.transform.localPosition.x <=
                currentGun.retroActionFineSightForce - 0.02f)
            {
                currentGun.transform.localPosition =
                    Vector3.Lerp(currentGun.transform.localPosition,
